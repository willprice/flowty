...
from c_core cimport Mat as c_Mat, InputArray, OutputArray, InputOutputArray, CV_32FC2, cvtColor, ColorConversionCodes
...
cdef class TvL1OpticalFlow:
    ...
    def __repr__(self):
        return (self.__class__.__name__ +
            ("("
             "tau={tau}, lambda_={lambda_}, epsilon={epsilon}, gamma={gamma}, "
